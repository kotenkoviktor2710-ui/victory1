...
import { getLocalizedFlowchartArcs } from "./i18n.js";
...
/** @returns {FlowArc[]} */
export function getFlowchartArcs() {
  return getLocalizedFlowchartArcs(FLOWCHART_ARCS);
}
...
export function buildMergedStoryGraph() {
  ...
  for (const arc of getFlowchartArcs()) {
