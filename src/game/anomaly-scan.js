import { startScanningSound, stopScanningSound } from "./ui-sounds.js";

/** Длительность одного прохода луча сверху вниз — совпадает с `scanning.wav`. */
const SCAN_PASS_DURATION_MS = 4136;
const RESET_SPEED = 32;
const REVEAL_THRESHOLD = 6.5;
const SCAN_LOOP_TOP = -4;
const SCAN_LOOP_BOTTOM = 104;
const SCAN_TRAVEL = SCAN_LOOP_BOTTOM - SCAN_LOOP_TOP;
const SCAN_SPEED = (SCAN_TRAVEL / SCAN_PASS_DURATION_MS) * 1000;
const PING_MS = 420;
 ...
 */
export function startAnomalyScan(novel, sceneKey, onReveal, sfxVolume = 80) {
